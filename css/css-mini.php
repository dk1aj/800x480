...
.node {
    ...
    text-align: center;
    font-weight:600;
    background: linear-gradient(to bottom, transparent 0%,rgb(0, 255, 72) 0%), linear-gradient(#F7f7f7, #EEE);
}
...
.node-talk3 {
  ...
  font-size: 1.5rem;
  font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
  background: linear-gradient(to bottom, #003a33, #00564d);
  color: #ffffff;
  box-shadow: 0 4px 10px rgba(0, 255, 200, 0.4);
  touch-action: manipulation;
}
