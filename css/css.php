...
.menu {background-color: #2A6594; outline:none;}
.dropbtn {
...
<!-- .node-talk_### {
    display: inline-block;
    width: 90%;         /* nimmt 90% des Elternelements ein */
    max-width: 600px;   /* verhindert zu große Box auf großen Bildschirmen */
    height: auto;       /* passt sich dem Inhalt an */
    padding: 10px;      /* etwas mehr Platz innen */
    border: 1px solid #000;
    border-radius: 5px;
    margin: 10px auto;  /* zentriert das Element horizontal */
    text-align: center;
    font-weight: 600;
    background: linear-gradient(to bottom, transparent 0%, #08a103 0%), linear-gradient(#F7f7f7, #EEE);
...
<!-- .node-talk1_#### {
    ...
    font-weight:600;
    // font-family: "Lucidia Console",Monaco,monospace;
    background: linear-gradient(to bottom, transparent 0%,rgb(0, 255, 255) 0%), linear-gradient(#ff0000, #EEE);
} -->
...
<!-- .node-talk2_#### {
    ...
    font-weight:600;
    // font-family: "Lucidia Console",Monaco,monospace;
    background: linear-gradient(to bottom, transparent 0%,rgb(228, 216, 45) 0%), linear-gradient(#F7f7f7, #EEE);
} -->
...
.node-info {
    ...
    font-weight:600;
    // font-family: "Lucidia Console",Monaco,monospace;
    background: linear-gradient(to bottom, transparent 0%,  #828282 0%), linear-gradient(#F7f7f7, #EEE);
}
